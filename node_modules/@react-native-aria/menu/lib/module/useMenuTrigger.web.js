...
export function useMenuTrigger(props, state, ref) {
  let params = useMenuTriggerWeb(props, state, ref); // onKeyDown is not supported in Pressable so used onKeyDownCapture instead!
  ...
  params.menuTriggerProps = mapDomPropsToRN(params.menuTriggerProps); // @ts-ignore - Get types for Universal apps
