...
export type ISliderComponentType<StyledSlider, StyledSliderThumb, StyledSliderTrack, StyledSliderFilledTrack> = React.ForwardRefExoticComponent<StyledSlider & ISliderProps> & {
    ...
    FilledTrack: React.ForwardRefExoticComponent<StyledSliderFilledTrack & ISliderTrackFilledProps>;
};
