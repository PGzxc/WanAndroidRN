...
export type IFormControlComponentType<Root, Error, ErrorText, ErrorIcon, Label, LabelText, LabelAstrick, Helper, HelperText> = React.ForwardRefExoticComponent<Root & InterfaceFormControlProps> & {
