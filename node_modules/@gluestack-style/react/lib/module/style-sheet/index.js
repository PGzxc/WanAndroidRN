...
export class StyleInjector {
  ...
  resolveComponentTheme(componentTheme, theme, componentExtendedConfig, componentHashKey, CONFIG) {
    ...
    componentTheme.resolved = StyledValueToCSSObject(theme, componentExtendedConfig);
  ...
  injectStyles(cssRuleset, _wrapperType, _styleTagId, inlineStyleMap) {
    if (cssRuleset) {
      inject(`@media screen {${cssRuleset}}`, _wrapperType, _styleTagId, inlineStyleMap);
    }
  }
}
