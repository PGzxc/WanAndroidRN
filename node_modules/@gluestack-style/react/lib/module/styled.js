...
function convertUtiltiyToSXFromProps(componentProps, styledSystemProps, componentStyleConfig) {
  ...
  } = convertUtilityPropsToSX(styledSystemProps, componentStyleConfig === null || componentStyleConfig === void 0 ? void 0 : componentStyleConfig.descendantStyle, componentRestProps);
...
export function verboseStyled(Component, theme) {
  ...
  const StyledComponent = (_ref, ref) => {
    ...
    const [applyDescendantStateStyleCSSIdsAndPropsWithKey, setApplyDescendantStateStyleCSSIdsAndPropsWithKey] = useState(mergedDescendantsStyle);
    // const [
    ...
    const descendantCSSIds = useMemo(() => {
      ...
      return ids;
    }, [stableHash(applyDescendantsStyleCSSIdsAndPropsWithKey), stableHash(applyDescendantStateStyleCSSIdsAndPropsWithKey), stableHash(applySxDescendantStateStyleCSSIdsAndPropsWithKey.current), ancestorStyleContext]);
    ...
    const resolvedStyleProps = generateStylePropsFromCSSIds(applyComponentInlineProps, styleCSSIds, CONFIG, activeTheme);
    ...
    if (AsComp) {
      ...
      if (Component.isStyledComponent) {
        component = /*#__PURE__*/React.createElement(ComponentWithPlugin, _extends({}, resolvedStyleProps, propsToBePassedInToPlugin, {
