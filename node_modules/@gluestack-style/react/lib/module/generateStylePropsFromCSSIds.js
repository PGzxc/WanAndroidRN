...
export function isValidBreakpoint(config, queryCondition) {
  var _Dimensions$get;
  let width = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : (_Dimensions$get = Dimensions.get('window')) === null || _Dimensions$get === void 0 ? void 0 : _Dimensions$get.width;
...
export function generateStylePropsFromCSSIds(props, styleCSSIds, config, activeTheme) {
