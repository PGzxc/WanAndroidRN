...
export function updateOrderUnResolvedMap(theme, componentHash, declarationType, ExtendedConfig) {
  let _GluestackStyleSheet = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : GluestackStyleSheet;
